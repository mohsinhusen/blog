                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>લોન નફો</label>
                                            <input type="number" name="loan_profit" class="form-control" id="loan_profit" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>લોન રકમ</label>
                                            <input type="number" name="loan_amount" class="form-control" id="loan_amount" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="loan_duration" class="form-control" id="loan_duration" required min="1" max="2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="paid_inst" class="form-control" id="paid_inst" required min="1" max="2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="remain_profit" class="form-control"
                                                id="remain_profit" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>બાકી રકમ</label>
                                            <input type="text" name="remain_amt" class="form-control"
                                                id="remain_amt" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>મળેલ રકમ</label>
                                            <input type="text" name="recv_amt" class="form-control"
                                                id="recv_amt" disabled>
                                        </div>
                                    </div>
                                            {{-- <label>નફાના ટકા</label> --}}
                                            <input type="text" name="profit_percent" class="form-control"
                                                id="profit_percent" disabled hidden>
                                            <input type="text" name="profit_per" class="form-control" id="profit_per"
                                                disabled hidden>
                                            <input type="text" name="month_profit" class="form-control" id="month_profit"
                                                disabled hidden>
                                            <input type="text" name="group_profit" class="form-control" id="group_profit"
                                                disabled hidden>
                                            <input type="text" name="return_profit" class="form-control" id="return_profit"
                                                disabled hidden>
                                    <div class="col-md-4">
                                        <div class="form-group">
