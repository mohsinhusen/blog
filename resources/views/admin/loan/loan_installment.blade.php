...
@section('content')
    <div class="container">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Installment Paid
                    ...
                    <form action="{{ url('installment-store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Reason</label>
                                    <input type="text" id="reason" name="reason" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input type="date" id="inst_date" name="inst_date" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Penalty</label>
                                    <input type="text" id="inst_penalty" name="inst_penalty" value="0" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" id="txt_inst_amount" name="txt_inst_amount" class="form-control">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" id="inst_profit" name="inst_profit" class="form-control">
                                </div>
                            </div>
